...
def main():
    ...
    parser.add_argument("--continuous-scale-ema", type=float, default=None,
                        help="Override continuous mode EMA coefficient for boost scale smoothing (default: 0.3)")
    ...
    asgml_overrides = {
        ...
        "continuous_scale_ema": args.continuous_scale_ema,
    }
