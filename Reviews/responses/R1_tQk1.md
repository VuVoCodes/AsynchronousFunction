...
| PGGB (probes + boost) | 17.71 | **+1.61%** | ~12.2 GB |
...
5. No explicit warm-up period is used, and none is needed: scales initialize at the neutral $s_m = 1$, the first probe event lands at iteration 19 of 10,500, and single-event exposure is bounded as in point 4.
...
3. We will reword the abstract, the introduction, and the corresponding statements in Sections 3.3 and 4.2 in the updated version to characterize the results precisely as safety guarantees. The revised sentence is presented as follows.
