...
Your review directly produced the Adam measurement and the $n=10$ analysis, and we believe the paper is more honest for both. If any of the above raises further questions, we would welcome the chance to run additional analysis during the discussion period.
