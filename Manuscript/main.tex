...
\begin{itemize}
    ...
    \item We validate \emph{probe-guided gradient boosting} on eight benchmarks across classification, regression, and segmentation. The positive effect is concentrated on high-imbalance audio-visual (CREMA-D) and medical segmentation (BraTS~2021), with near-neutral behavior and isolated regressions on low-imbalance benchmarks (Section~\ref{sec:conclusion}).
\end{itemize}
